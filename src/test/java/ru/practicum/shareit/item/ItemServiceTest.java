...
class ItemServiceTest {
    ...
    void initialize() {
        ...
        item = new Item(
                ...
                "Deep pocket",
                true,
                convertDtoToModel(userDto),
                null);
        itemDto = ItemMapper.convertModelToDto(item);
    }
    ...
    private ItemDto saveItemDto() {
        ...
        when(itemRepository.save(any()))
                .thenReturn(ItemMapper.convertDtoToModel(itemDto));
    ...
    void updateTest() {
        ...
        when(itemRepository.save(any()))
                .thenReturn(updated);
        ItemDto update = itemService.update(ItemMapper.convertModelToDto(updated), userDto.getId(), 1L);
