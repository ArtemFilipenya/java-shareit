...
class UserServiceTest {
    ...
    void saveUserSameEmailTest() {
        when(userRepository.save(any()))
                .thenThrow(BadParameterException.class);
    ...
    void updateUserNameTest() {
        ...
        userService.save(userDto);
        when(userRepository.save(any()))
                .thenReturn(convertDtoToModel(userDto2));
        when(userRepository.findById(any()))
                .thenReturn(ofNullable(convertDtoToModel(userDto2)));
    ...
    void updateUserSameEmailTest() {
        ...
        when(userRepository.findById(any()))
                .thenReturn(ofNullable(convertDtoToModel(dto)));
        when(userRepository.save(any()))
                .thenThrow(BadParameterException.class);
        assertThrows(BadParameterException.class,
                () -> userService.update(
